...
public class PlayerManager : MonoBehaviour
{
    ...
    {
        // Stop Flythrough if it's playing
        if (m_InFlythrough && FlythroughDirector != null)
        {
            FlythroughDirector.Stop();
        }

        // Additional actions on game end, if needed
        // For example, disable player controls, show end game UI, etc.
